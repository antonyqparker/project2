...
Exercise.create(name:"close grip pull-up", difficulty:"easy", reps:"", description:"Exactly the same as the regular pull up except your hands are very close together.  This exercise should be performed with a reversed grip", youtube_url:"", image_url:"", image_url:"/public/images/Pullup.png")
